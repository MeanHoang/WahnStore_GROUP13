<%@ Page Title="" Language="C#" MasterPageFile="~/Layout_Admin.Master" AutoEventWireup="true" CodeBehind="ThemMoiProduct.aspx.cs" Inherits="WahnStore_GROUP13.ThemMoiProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <asp:Button runat="server" ID="btnThemMoi" Text="Thêm sản phẩm mới" OnClick="btnThemMoi_Click" />
